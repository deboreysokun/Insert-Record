...
public class TransactionBatchProcessing {
    Connection con = null;
    Statement st = null;
    public static void main(String[] args){
        new TransactionManagement().transact();
    }
    ...
    con.setAutoCommit(false);
        ...
        String add = "update ababank set balance = balance - '"+amt+"' where id ='"+debId+"'";
        String minus = "update ababank set balance = balance + '"+amt+"' where id ='"+creId+"'";
        st.addBatch(add);
        st.addBatch(minus);
        st.executeBatch();
        con.commit();
